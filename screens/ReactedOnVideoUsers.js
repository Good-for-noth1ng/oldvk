...
const ReactedOnVideoUsers = ({ navigation, route }) => {
  ...
  const fetchUsersWhoReacted = async () => {
    const likesListUrl = `https://api.vk.com/method/likes.getList?access_token=${accessToken}&v=5.131&type=video&count=${count}&offset=${offset.current}&owner_id=${ownerId}&item_id=${videoId}`
...
export default ReactedOnVideoUsers
